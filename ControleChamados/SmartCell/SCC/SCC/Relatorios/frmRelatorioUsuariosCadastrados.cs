...
namespace SCC.Relatorios
{
    public partial class frmRelatorioUsuariosCadastrados : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'dbsccDataSet.usuarios' table. You can move, or remove it, as needed.
            this.usuariosTableAdapter.Fill(this.dbsccDataSet.usuarios);
