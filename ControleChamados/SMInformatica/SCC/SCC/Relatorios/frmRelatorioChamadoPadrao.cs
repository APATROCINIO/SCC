    ...
    public partial class frmRelatorioChamadoPadrao : Form
    {
        ...
        private void frmRelatorioChamadoPadrao_Load(object sender, EventArgs e)
        {
            ...
            if (valIdChamadoImpressao != 0)
            {
                ...
                // TODO: This line of code loads data into the 'dbsccDataSet1.view_chamadopadrao' table. You can move, or remove it, as needed.
                this.view_chamadopadraoTableAdapter.Fill(this.dbsccDataSet1.view_chamadopadrao, valIdChamadoImpressao);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (valIdChamadoImpressao != 0)
            {
                ...
                // TODO: This line of code loads data into the 'dbsccDataSet1.view_chamadopadrao' table. You can move, or remove it, as needed.
                this.view_chamadopadraoTableAdapter.Fill(this.dbsccDataSet1.view_chamadopadrao, Convert.ToInt32(valIdChamadoImpressao));
