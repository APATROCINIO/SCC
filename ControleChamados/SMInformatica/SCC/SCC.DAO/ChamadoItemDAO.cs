    ...
    public class ChamadoItemDAO
    {
        ...
        public int IncluirChamadoItem(ChamadoItemDTO objChamadoItemDTO)
        {
            using (MySqlConnection mysqlCON = new MySqlConnection())
            {
                ...
                //conexão csSCC criada manualmente nas propriedades da Classe DAO
                mysqlCON.ConnectionString = Properties.Settings.Default.csSCC;
                ...
                MCCommand.Parameters.AddWithValue("@CelularPossuiCarregador", objChamadoItemDTO.CelularPossuiCarregador);
                MCCommand.Parameters.AddWithValue("@CelularPossuiCartaoMemoria", objChamadoItemDTO.CelularPossuiCartaoMemoria);
                MCCommand.Parameters.AddWithValue("@CelularPossuiChip", objChamadoItemDTO.CelularPossuiChip);
                MCCommand.Parameters.AddWithValue("@PadraoPossuiCarregador", objChamadoItemDTO.PadraoPossuiCarregador);
                MCCommand.Parameters.AddWithValue("@PadraoMarcaModeloSerie", objChamadoItemDTO.PadraoMarcaModeloSerie);
